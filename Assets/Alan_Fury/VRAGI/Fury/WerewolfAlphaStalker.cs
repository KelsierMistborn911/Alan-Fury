...
/// IsConcealedAt() зовётся из NpcPerception — это «невидим в тумане».
/// ВАЖНО: если на волке есть WerewolfBrain — он сам включает этот скрипт в режиме Stalk.
/// Без мозга сталкер работает как раньше (идёт к PlayerPos).
/// </summary>
[RequireComponent(typeof(NpcPerception))]
[RequireComponent(typeof(WerewolfLocomotion))]
public class WerewolfAlphaStalker : MonoBehaviour
{
    [Header("Ссылки")]
    ...
    /// <summary>Скрыт ли hider от seeker'а укрытием. Зовётся из NpcPerception.</summary>
